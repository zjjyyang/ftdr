...
public:
    ...
    */
	...
	//added by zhangjy on 2010.1.31,to support the global calibrate
    rampPeakList *pkl;
	long Last,First;
	double bMass;
	int charge;
	...
	int TFindL(rampPeakList *pkl,int b,int e,double fmz);
