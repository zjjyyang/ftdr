...
class IXRawfile : public COleDispatchDriver
{
public:
	IXRawfile() {}		// Calls COleDispatchDriver default constructor
	IXRawfile(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	IXRawfile(const IXRawfile& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	//////////////////////////////////////////
	void GetLabelData( VARIANT FAR* pvarLabels, VARIANT FAR* pvarFlags,long FAR* pnScanNumber);
	void GetNoiseData(VARIANT* pvarNoisePacket,long* pnScanNumber);
	/////////////////////////////////////////v2.0 function
	...
	void GetNumTuneData(long* pnNumTuneData);//ÖØÒªº¯Êý
	...
	void GetTrailerExtraLabelsForScanNum(long nScanNumber, VARIANT* pvarLabels, long* pnArraySize);
