...
//
#define TPP_RELEASE_NAME "VUVUZELA" // rc: release candidate
#define TPP_MAJOR_RELEASE_NUMBER 4
#define TPP_MINOR_RELEASE_NUMBER 4
...
const char szTPPVersionInfo[1024]="v4.4"; // in VersionInfo.o, generated at build time
const time_t globTPPBuildTime=1000l; // in VersionInfo.o, generated at build time
